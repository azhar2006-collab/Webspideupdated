...
fs.copyFileSync('FRONT-END DEVELOPMENT SERVICES .docx', 'temp.zip');
...
fs.writeFileSync('frontend_docx_text.txt', fullText, 'utf-8');
console.log(`Extracted ${texts.length} paragraphs to frontend_docx_text.txt`);
