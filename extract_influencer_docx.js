...
fs.copyFileSync('INFLUENCER MARKETING SERVICES .docx', 'temp.zip');
...
fs.writeFileSync('influencer_docx_text.txt', fullText, 'utf-8');
console.log(`Extracted ${texts.length} paragraphs to influencer_docx_text.txt`);
