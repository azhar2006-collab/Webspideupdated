...
fs.copyFileSync('SOCIAL MEDIA MANAGEMENT SERVICES .docx', 'temp.zip');
...
fs.writeFileSync('manage_docx_text.txt', fullText, 'utf-8');
console.log(`Extracted ${texts.length} paragraphs to manage_docx_text.txt`);
