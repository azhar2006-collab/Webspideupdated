...
fs.copyFileSync('SOCIAL MEDIA MARKETING SERVICES .docx', 'temp.zip');
...
fs.writeFileSync('smmarket_docx_text.txt', fullText, 'utf-8');
console.log(`Extracted ${texts.length} paragraphs to smmarket_docx_text.txt`);
