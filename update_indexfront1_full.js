...
const filePath = path.join(__dirname, 'indexfront1.html');
let html = fs.readFileSync(filePath, 'utf8');

console.log('Original indexfront1.html size:', html.length);

// ── 1. HEAD / META ──────────────────────────────────────────────────────────
html = html.replace(
  /<title>.*?<\/title>/i,
  '<title>Front-End Development Services | Webspide</title>'
);
...
// ── 2. HERO SECTION ────────────────────────────────────────────────────────
html = html.replace(
  '<div class="badge fade-in">Custom Web Solutions</div>',
...
// B1 Cards (6 cards)
const b1CardsOldRegex = /<!-- B1 CARDS GRID -->[\s\S]*?<!-- B2 CARDS GRID -->/;
...
html = html.replace(b1CardsOldRegex, b1CardsNewHtml + '\n\n    <!-- B2 CARDS GRID -->');

// ── 4. SERVICES SECTION ───────────────────────────────────────────────────
html = html.replace(
  /<h2 class="section-title gradient-heading">Our Custom Web Development Services<\/h2>/i,
  '<h2 class="section-title gradient-heading">Our Front-End Development Services</h2>'
);

html = html.replace(
  /<p class="section-sub" style="margin-bottom:0">End-to-end web solutions engineered for performance, scalability, and seamless connectivity across every platform.<\/p>/i,
...
// 10 Service Cards Replacement
const svcCardsStart = html.indexOf('<!-- CARD 01');
const svcCardsEnd = html.indexOf('</section>', svcCardsStart);

const newSvcCardsHtml = `<!-- CARD 01 — Custom Front-End Development -->
  <div class="service-card reveal" id="svc-card-1">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-front-end-services.webp" alt="Custom Front-End Development" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>

  <!-- CARD 02 — Responsive Web Development -->
  <div class="service-card reveal" id="svc-card-2">
    <div class="card-text">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-full-stack-services.webp" alt="Responsive Web Development" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>
  ...
  <div class="service-card reveal" id="svc-card-3">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-cms-development-services.webp-artguru.webp" alt="UI/UX Development &amp; Prototyping" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>

  <!-- CARD 04 — Single Page Application Development -->
  <div class="service-card reveal" id="svc-card-4">
    <div class="card-text">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-enterprise-portals.webp" alt="Single Page Application Development" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>
  ...
  <div class="service-card reveal" id="svc-card-5">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-back-end-services.webp" alt="Front-End Framework Development" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>

  <!-- CARD 06 — JavaScript Development & Optimization -->
  <div class="service-card reveal" id="svc-card-6">
    <div class="card-text">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-api-integrations.webp" alt="JavaScript Development &amp; Optimization" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>
  ...
  <div class="service-card reveal" id="svc-card-7">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-performance-optimization.webp" alt="Front-End Performance Optimization" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>

  <!-- CARD 08 — Cross-Browser & Cross-Platform Compatibility -->
  <div class="service-card reveal" id="svc-card-8">
    <div class="card-text">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-website-migration.webp" alt="Cross-Browser &amp; Cross-Platform Compatibility" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>
  ...
  <div class="service-card reveal" id="svc-card-9">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-progressive-web-apps.webp" alt="Progressive Web App Development" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>

  <!-- CARD 10 — CMS & eCommerce Front-End Integration -->
  <div class="service-card reveal" id="svc-card-10">
    <div class="card-text">
    ...
    <div class="card-visual">
      <div class="illus-wrap float-anim-d2" style="max-width:340px; position:relative;">
        <img src="custom-web-development-ecommerce-platform.webp" alt="CMS &amp; eCommerce Front-End Integration" style="width:100%;height:auto;display:block;border:none;outline:none;border-radius:0;box-shadow:none;mix-blend-mode:multiply;filter:contrast(1.05) saturate(1.1);background:transparent;">
      </div>
    </div>
  </div>`;

html = html.substring(0, svcCardsStart) + newSvcCardsHtml + html.substring(svcCardsEnd);
...
html = html.replace(
  /<div class="left-title gradient-heading">Why Choose<br>Webspide For<br><span class="purple">Custom Web<br>Development<br>Services\?<\/span><\/div>/i,
...
html = html.replace(
  /<p class="left-desc">Webspide combines business understanding, thoughtful design[\s\S]*?<\/p>/i,
...
// ── 7. WORKFLOW / HOW WE WORK SECTION ─────────────────────────────────────
html = html.replace(
...
// ── 8. ORBITAL SERVICES ARRAY IN SCRIPT ───────────────────────────────────
...
console.log('Successfully updated indexfront1.html! New size:', html.length);
